...
public:
    InstructionSet();
    string getFormat(const string& instruction) const;
    string getOpcode(const string& instruction) const;
    string getFunct3(const string& instruction) const;
    string getFunct7(const string& instruction) const;
    bool hasImmediate(const string& instruction) const;
...
public:
    ...
    string generateMachineCode(const string& instructionLine) const;
